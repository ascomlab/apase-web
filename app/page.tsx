...
const aboutData = {
  ...
  descriptions: [
    "2026 The 5th Asia-Pacific Aerospace Science and Engineering Symposium (APASE 2026), the annual conference held from the year 2020 with the name of The Innovation Aviation & Aerospace Industry (IAAI)- International Conference, will take place on December 18-21, 2026. in Harbin, China. Accepted papers in APASE 2026 will be submitted for publication into **EI Compendex(Journal of Physics: Conference Series, JPCS).** The APASE 2026 conference focuses on innovations in aviation and aerospace by fostering knowledge and new ideas for research work within the community, speakers, plenary speeches, young researchers and practitioners.",
